export class Poems1 {
  ...
  getPoems1Data() {
    let data =
    {
      nowidaho: { id: "nowidaho", img: "nowIdaho.jpg", title: "Now Idaho", poem: this.nowIdaho },
      valiantandotherwise: { id: "valiantandotherwise", img: "valiantAndOtherwise.jpg", title: "Valiant and Otherwise", poem: this.valiantAndOtherwise },
